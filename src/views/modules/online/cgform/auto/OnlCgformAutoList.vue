  ...
  <a-card :bordered="false" style="height: 100%">
    ...
    <div class="table-operator">
      ...
      <template v-if="hasBpmStatus">
        ...
        <a-button @click="handleCancelWF" type="primary" icon style="margin-left:8px">删除审批</a-button>
      </template>
          ...
          <a-dropdown>
            ...
            <a-menu slot="overlay">
              <template v-if="hasBpmStatus">
                ...
                <a-menu-item>
                  <a href="javascript:;" @click="handleApprove(record)">同意</a>
                </a-menu-item>
                <a-menu-item>
                  <a href="javascript:;" @click="handleReject(record)">驳回</a>
                </a-menu-item>
                <a-menu-item>
                  <a href="javascript:;" @click="handleCancel(record)">撤销</a>
                </a-menu-item>
                <a-menu-item>
                  <a href="javascript:;" @click="handleEnd(record)">终止</a>
                </a-menu-item>
              </template>
              <template v-else>
                <template v-if="buttonSwitch.update">
